...
abstract class BaseVideoPeer {
	...
	const UPLOAD_DATE = 'video.UPLOAD_DATE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'AuthorId', 'CategoryId', 'Title', 'Desc', 'UploadDate', 'Url', 'Slug', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'authorId', 'categoryId', 'title', 'desc', 'uploadDate', 'url', 'slug', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::AUTHOR_ID, self::CATEGORY_ID, self::TITLE, self::DESC, self::UPLOAD_DATE, self::URL, self::SLUG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'author_id', 'category_id', 'title', 'desc', 'upload_date', 'url', 'slug', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AuthorId' => 1, 'CategoryId' => 2, 'Title' => 3, 'Desc' => 4, 'UploadDate' => 5, 'Url' => 6, 'Slug' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'authorId' => 1, 'categoryId' => 2, 'title' => 3, 'desc' => 4, 'uploadDate' => 5, 'url' => 6, 'slug' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::AUTHOR_ID => 1, self::CATEGORY_ID => 2, self::TITLE => 3, self::DESC => 4, self::UPLOAD_DATE => 5, self::URL => 6, self::SLUG => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'author_id' => 1, 'category_id' => 2, 'title' => 3, 'desc' => 4, 'upload_date' => 5, 'url' => 6, 'slug' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(VideoPeer::AUTHOR_ID);
		$criteria->addSelectColumn(VideoPeer::CATEGORY_ID);
		$criteria->addSelectColumn(VideoPeer::TITLE);
		$criteria->addSelectColumn(VideoPeer::DESC);
		$criteria->addSelectColumn(VideoPeer::UPLOAD_DATE);
		$criteria->addSelectColumn(VideoPeer::URL);
	...
	public static function doCountJoinAuthor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(VideoPeer::AUTHOR_ID, AuthorPeer::ID, $join_behavior);
	...
	public static function doCountJoinCategory(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(VideoPeer::CATEGORY_ID, CategoryPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Video objects pre-filled with their Author objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAuthor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Video) to $obj2 (Author)
				$obj2->addVideo($obj1);
	...
	/**
	 * Selects a collection of Video objects pre-filled with their Category objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Video objects.
	...
	public static function doSelectJoinCategory(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Video) to $obj2 (Category)
				$obj2->addVideo($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		VideoPeer::addSelectColumns($criteria);
		$startcol2 = (VideoPeer::NUM_COLUMNS - VideoPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Video) to the collection in $obj2 (Author)
				$obj2->addVideo($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Video) to the collection in $obj3 (Category)
				$obj3->addVideo($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Video objects pre-filled with all related objects except Author.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptAuthor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = VideoPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Video) to the collection in $obj2 (Category)
				$obj2->addVideo($obj1);
	...
	/**
	 * Selects a collection of Video objects pre-filled with all related objects except Category.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
