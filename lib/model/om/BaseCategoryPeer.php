...
abstract class BaseCategoryPeer {
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CategoryPeer::DESC);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoryPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCategoryPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoryPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCategoryPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoryPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCategoryPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoryPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCategoryPeer', $values, $con, $ret);
    }
