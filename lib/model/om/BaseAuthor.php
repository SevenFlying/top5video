...
abstract class BaseAuthor extends BaseObject  implements Persistent {
	...
	public function setDesc($v)
	{
		...
		if ($this->desc !== $v) {
			$this->desc = $v;
			$this->modifiedColumns[] = AuthorPeer::DESC;
		}
	...
	public function setSlug($v)
	{
		...
		if ($this->slug !== $v) {
			$this->slug = $v;
			$this->modifiedColumns[] = AuthorPeer::SLUG;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AuthorPeer::DESC)) $criteria->add(AuthorPeer::DESC, $this->desc);
		if ($this->isColumnModified(AuthorPeer::SLUG)) $criteria->add(AuthorPeer::SLUG, $this->slug);
	 ...
	 * related Videos from storage. If this Author is new, it will return
		...
		if ($this->collVideos === null) {
			if ($this->isNew()) {
			   $this->collVideos = array();
				...
				$criteria->add(VideoPeer::AUTHOR_ID, $this->id);
	 ...
	 */
	public function getVideosJoinCategory($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AuthorPeer::DATABASE_NAME);
		}
		...
		if ($this->collVideos === null) {
			if ($this->isNew()) {
				...
				$this->collVideos = VideoPeer::doSelectJoinCategory($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
