...
abstract class BaseCategory extends BaseObject  implements Persistent {
	...
	public function setDesc($v)
	{
		...
		if ($this->desc !== $v) {
			$this->desc = $v;
			$this->modifiedColumns[] = CategoryPeer::DESC;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CategoryPeer::DESC)) $criteria->add(CategoryPeer::DESC, $this->desc);
	 ...
	 * related Videos from storage. If this Category is new, it will return
		...
		if ($this->collVideos === null) {
			if ($this->isNew()) {
			   $this->collVideos = array();
				...
				$criteria->add(VideoPeer::CATEGORY_ID, $this->id);
	 ...
	 */
	public function getVideosJoinAuthor($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CategoryPeer::DATABASE_NAME);
		}
		...
		if ($this->collVideos === null) {
			if ($this->isNew()) {
				...
				$this->collVideos = VideoPeer::doSelectJoinAuthor($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
