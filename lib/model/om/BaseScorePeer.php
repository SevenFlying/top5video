...
/**
 * Base static class for performing query and update operations on the 'score' table.
 *
 * 
 *
...
abstract class BaseScorePeer {
	...
	const OM_CLASS = 'Score';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.Score';
	...
	const VIDEO_ID = 'score.VIDEO_ID';

	/** the column name for the STARS field */
	const STARS = 'score.STARS';

	/** the column name for the SLUG field */
	const SLUG = 'score.SLUG';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'VideoId', 'Stars', 'Slug', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'videoId', 'stars', 'slug', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::VIDEO_ID, self::STARS, self::SLUG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'video_id', 'stars', 'slug', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'VideoId' => 1, 'Stars' => 2, 'Slug' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'videoId' => 1, 'stars' => 2, 'slug' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::VIDEO_ID => 1, self::STARS => 2, self::SLUG => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'video_id' => 1, 'stars' => 2, 'slug' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ScorePeer::VIDEO_ID);
		$criteria->addSelectColumn(ScorePeer::STARS);
		$criteria->addSelectColumn(ScorePeer::SLUG);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseScorePeer', $criteria, $con);
		}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ScorePeer::getOMClass(false);
	...
	public static function doCountJoinVideo(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ScorePeer::VIDEO_ID, VideoPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Score objects pre-filled with their Video objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinVideo(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ScorePeer::addSelectColumns($criteria);
		$startcol = (ScorePeer::NUM_COLUMNS - ScorePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Score) to $obj2 (Video)
				$obj2->addScore($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ScorePeer::addSelectColumns($criteria);
		$startcol2 = (ScorePeer::NUM_COLUMNS - ScorePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Score) to the collection in $obj2 (Video)
				$obj2->addScore($obj1);
	...
	{
		return $withPrefix ? ScorePeer::CLASS_DEFAULT : ScorePeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseScorePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseScorePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseScorePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseScorePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseScorePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseScorePeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(ScorePeer::ID, $criteria->remove(ScorePeer::ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseScorePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseScorePeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(ScorePeer::TABLE_NAME, $con);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseScorePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
