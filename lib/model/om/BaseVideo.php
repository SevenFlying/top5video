...
abstract class BaseVideo extends BaseObject  implements Persistent {
	 ...
	 */
	public function getUploadDate($format = 'Y-m-d')
	{
	...
	public function setAuthorId($v)
	{
		...
		if ($this->author_id !== $v) {
			$this->author_id = $v;
			$this->modifiedColumns[] = VideoPeer::AUTHOR_ID;
		}
	...
	public function setCategoryId($v)
	{
		...
		if ($this->category_id !== $v) {
			$this->category_id = $v;
			$this->modifiedColumns[] = VideoPeer::CATEGORY_ID;
		}
	...
	public function setDesc($v)
	{
		...
		if ($this->desc !== $v) {
			$this->desc = $v;
			$this->modifiedColumns[] = VideoPeer::DESC;
		}
	...
	public function setUploadDate($v)
	{
		...
		if ( $this->upload_date !== null || $dt !== null ) {
			...
			$currNorm = ($this->upload_date !== null && $tmpDt = new DateTime($this->upload_date)) ? $tmpDt->format('Y-m-d') : null;
			$newNorm = ($dt !== null) ? $dt->format('Y-m-d') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->upload_date = ($dt ? $dt->format('Y-m-d') : null);
				$this->modifiedColumns[] = VideoPeer::UPLOAD_DATE;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = VideoPeer::NUM_COLUMNS - VideoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VideoPeer::AUTHOR_ID)) $criteria->add(VideoPeer::AUTHOR_ID, $this->author_id);
		if ($this->isColumnModified(VideoPeer::CATEGORY_ID)) $criteria->add(VideoPeer::CATEGORY_ID, $this->category_id);
		if ($this->isColumnModified(VideoPeer::TITLE)) $criteria->add(VideoPeer::TITLE, $this->title);
		if ($this->isColumnModified(VideoPeer::DESC)) $criteria->add(VideoPeer::DESC, $this->desc);
		if ($this->isColumnModified(VideoPeer::UPLOAD_DATE)) $criteria->add(VideoPeer::UPLOAD_DATE, $this->upload_date);
	 ...
	 * related Scores from storage. If this Video is new, it will return
		...
		if ($this->collScores === null) {
			if ($this->isNew()) {
			   $this->collScores = array();
				...
				$criteria->add(ScorePeer::VIDEO_ID, $this->id);
