...
abstract class autoVideoActions extends sfActions
{
  ...
  protected function addSortCriteria($criteria)
  {
    ...
    $column = VideoPeer::translateFieldName($sort[0], BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_COLNAME);
    if ('asc' == $sort[1])
    {
  ...
  {
    return in_array($column, BasePeer::getFieldnames('Video', BasePeer::TYPE_FIELDNAME));
  }
}
